...
using NetFilmx_Service.Query.Cart.GetByUserId;
using NetFilmx_Service.Query.Cart.GetItemCount;
using NetFilmx_Service.Query.ViewHistory;
using NetFilmx_Service.Query.ViewHistory.GetByUserId;
using NetFilmx_Service.Query.ViewHistory.GetContinueWatching;
...
namespace NetFilmx_User.Extensions
{
    public static partial class ServiceCollectionExtension
    {
        ...
        public static IServiceCollection AddRequestHandlers(this IServiceCollection serviceCollection)
        {
            ...
            // Cart Requests
            serviceCollection.AddTransient<IRequestHandler<GetCartByUserIdQuery<CartDetailsDto>, CResult<CartDetailsDto>>, GetCartByUserIdQueryHandler>();
            serviceCollection.AddTransient<IRequestHandler<GetCartItemCountQuery, CResult<int>>, GetCartItemCountQueryHandler>();

            // ViewHistory Requests
            serviceCollection.AddTransient<IRequestHandler<GetViewHistoryByUserIdQuery<ViewHistoryDetailsDto>, CResult<List<ViewHistoryDetailsDto>>>, GetViewHistoryByUserIdQueryHandler>();
            serviceCollection.AddTransient<IRequestHandler<GetContinueWatchingQuery<ViewHistoryDetailsDto>, CResult<List<ViewHistoryDetailsDto>>>, GetContinueWatchingQueryHandler>();

            // Favorites Requests (already implemented)
            serviceCollection.AddTransient<IRequestHandler<GetFavoritesByUserIdQuery<FavoriteListDto>, CResult<IEnumerable<FavoriteListDto>>>, GetFavoritesByUserIdQueryHandler>();

            // UserSettings Requests (already implemented)
            serviceCollection.AddTransient<IRequestHandler<GetUserSettingsByUserIdQuery<UserSettingsDetailsDto>, CResult<UserSettingsDetailsDto>>, GetUserSettingsByUserIdQueryHandler>();
